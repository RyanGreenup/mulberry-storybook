...
import { filterValidImages } from "../src/mulberry/components/VirtualPhotoGrid";
import { VirtualPhotoGrid } from "../src/mulberry";
...
export const Default: Story = {
  render: () => {
    const [selectedPhoto, setSelectedPhoto] = createSignal<
      string | undefined
    >();
    ...
    return (
      <div>
        <div class={css({ mb: 4, p: 3, bg: "base.200", borderRadius: "box" })}>
          <h3 class={css({ fontWeight: "bold", mb: 2 })}>
          ...
          fallback={
            ...
            >
              <div class={css({ textAlign: "center" })}>
                ...
                />
                <p class={css({ color: "content.neutral" })}>
                  Validating images...
                </p>
              </div>
            </div>
              ...
              <>
                ...
                <VirtualPhotoGrid
                  ...
                  onPhotoDblClick={(photo) =>
                    console.log("Opening valid photo:", photo.title)
                  }
                />
              </>
            );
